...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="RolesUtilisateur.css">
...
<div class = "TitreMembre"> Devenez membre en vous inscrivant ici!  <br></div>
<a href="form.php" class="boutonPageActuel"> Devenir membre </a>
