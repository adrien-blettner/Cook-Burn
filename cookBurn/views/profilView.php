...
start_page ('form', array ('<link rel="stylesheet" type="text/css" href="/views/css/profil.css">'));
start_page ('form', array ('<link rel="stylesheet" type="text/css" href="/pasUtileSorry/rolesUtilisateur.css">'));
?>
